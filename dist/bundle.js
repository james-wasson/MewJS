...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4d8e3ddc0e7f39320ae2";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Component\", function() { return ComponentFactory; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MountComponent\", function() { return MountComponent; });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/utils.js\");\n/* harmony import */ var _childParser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./childParser */ \"./src/parser/childParser.js\");\n/* harmony import */ var _parentParser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parentParser */ \"./src/parser/parentParser.js\");\n/* harmony import */ var _selfParser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./selfParser */ \"./src/parser/selfParser.js\");\n/* harmony import */ var _htmlParser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./htmlParser */ \"./src/parser/htmlParser.js\");\n/* harmony import */ var _hooksParser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hooksParser */ \"./src/parser/hooksParser.js\");\n/* harmony import */ var _proxyContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../proxyContext */ \"./src/proxyContext.js\");\n/* harmony import */ var _typeManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../typeManager */ \"./src/typeManager.js\");\n/* harmony import */ var _callHooks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../callHooks */ \"./src/callHooks.js\");\n/* harmony import */ var _computedProp__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../computedProp */ \"./src/computedProp.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass Component {\r\n    constructor(compDescriptor, html, parentScope, parentNode, componentName) {\r\n        this.$isDestroyed = false;\r\n        this.$componentName = componentName;\r\n        this.$proxy = Object(_proxyContext__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(this);\r\n        this.$className = \"Component\";\r\n        this.$rootNode = parentNode;\r\n        this.$slots = {};\r\n        this.$emit = {};\r\n        this.$parent = null;\r\n        this.$watchers = {};\r\n        this.$listeners = {};\r\n        this.$inheritedProps = [];\r\n        this.$children = {\r\n            $listeners: {},\r\n            $components: {},\r\n            $activeComponents: []\r\n        }\r\n        this.$htmlEvents = {};\r\n        this.$hooks = {\r\n            $created: null,\r\n            $mounted: null\r\n        }\r\n        this.$nodes = [];\r\n        this.$_onMounted = [];\r\n        this.$destroyable = [];\r\n        this.$templateHtml = html;\r\n\r\n        if (!_typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isObject(compDescriptor.self)) {\r\n            throw new Error('Components must have self defined of type \"object\".');\r\n        }\r\n\r\n        if (compDescriptor.hasOwnProperty('parent'))\r\n            _parentParser__WEBPACK_IMPORTED_MODULE_2__[\"default\"].call(this, this, compDescriptor.parent, parentScope);\r\n\r\n        _selfParser__WEBPACK_IMPORTED_MODULE_3__[\"default\"].call(this, this, compDescriptor.self);\r\n\r\n        if (compDescriptor.hasOwnProperty('children'))\r\n            _childParser__WEBPACK_IMPORTED_MODULE_1__[\"default\"].call(this, this, compDescriptor.children);\r\n\r\n        \r\n        if (compDescriptor.hasOwnProperty('hooks'))\r\n            _hooksParser__WEBPACK_IMPORTED_MODULE_5__[\"default\"].call(this, compDescriptor.hooks);\r\n        \r\n        \r\n        _htmlParser__WEBPACK_IMPORTED_MODULE_4__[\"default\"].call(this, html);\r\n\r\n\r\n        Object(_computedProp__WEBPACK_IMPORTED_MODULE_9__[\"initalizeComputedComponent\"])(this);\r\n\r\n    }\r\n\r\n    $destroy() {\r\n        this.$isDestroyed = true;\r\n        this.$destroyable.forEach(p => p.$destroy());\r\n        this.$children.$activeComponents.forEach(comp => comp.$component.$destroy());\r\n    }\r\n}\r\n\r\nclass ComponentFactory {\r\n    constructor(compDescriptor) {\r\n        if (_typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isObject(compDescriptor) && _typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isObject(compDescriptor.self) && _typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isString(compDescriptor.self.template))\r\n            this.$templateHtml = _utils__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getDocument(compDescriptor.self.template);\r\n        else\r\n            throw new Error('Self must have a string called template defined on it.');\r\n        \r\n        this.$descriptor = compDescriptor;\r\n        this.$className = \"ComponentFactory\";\r\n    }\r\n\r\n    $addScope(componentName, parentScope) {\r\n        this.$parentScope = parentScope;\r\n        this.$componentName = componentName;\r\n    }\r\n\r\n    $create(parentNode) {\r\n        var component = new Component(this.$descriptor, this.$templateHtml.cloneNode(true), this.$parentScope, parentNode, this.$componentName);\r\n                \r\n        if (component.$hooks.$created)\r\n            component.$hooks.$created.call(component.$proxy);\r\n\r\n        \r\n\r\n        return component.$proxy;\r\n    }\r\n\r\n    $clone() {\r\n        return new ComponentFactory(this.$descriptor);\r\n    }\r\n}\r\n\r\nfunction MountComponent(nodeOrId, componentFactory) {\r\n    if (!_typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isComponentFactory(componentFactory)) {\r\n        console.error('Mount type expects type of componentFactory.');\r\n        return null;\r\n    }\r\n\r\n    if (_typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isString(nodeOrId))\r\n        nodeOrId = document.getElementById(nodeOrId.replace('#', ''));\r\n    \r\n    if (_typeManager__WEBPACK_IMPORTED_MODULE_7__[\"typeChecker\"].isElementNode(nodeOrId)) {\r\n        var node = nodeOrId;\r\n\r\n        var instance = componentFactory.$create(node);\r\n        node.appendChild(instance.$templateHtml.content);\r\n        // calls the mounted hook\r\n        Object(_callHooks__WEBPACK_IMPORTED_MODULE_8__[\"callMountedHooks\"])(instance);\r\n        return instance;\r\n\r\n    } else {\r\n        console.error('mount point expects valid html id or node type');\r\n        return null;\r\n    }\r\n}\r\n\r\n\n\n//# sourceURL=webpack://Mew/./src/parser/parser.js?");
